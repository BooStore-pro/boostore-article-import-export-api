...
// ---- Хлебные крошки ----
$crumbs = ['<a href="index.php" style="color:#00d4ff;text-decoration:none;font-weight:600;">🏠 Главная</a>', '<a href="?site='.urlencode($currentSite).'" style="color:#00d4ff;text-decoration:none;font-weight:600;">📝 Статьи</a>'];
if ($action === 'get') $crumbs[] = '<a href="?action=get&site='.urlencode($currentSite).'" style="color:#888;text-decoration:none;">📥 Импорт</a>';
elseif ($action === 'update') {
    $crumbs[] = '<a href="?action=update&site='.urlencode($currentSite).'" style="color:#888;text-decoration:none;">📤 Экспорт</a>';
    if (!empty($_GET['step2'])) $crumbs[] = '<span style="color:#888;">📁 Выбор файлов</span>';
    if (!empty($_GET['confirm'])) $crumbs[] = '<span style="color:#888;">✓ Результат</span>';
}
...
<p style="color:#ff9800;font-size:12px;margin-top:6px;">💡 <strong>Удаление:</strong> добавьте <code>&lt;meta name="delete" content="true"&gt;</code> в HTML-файл и укажите <code>id</code> статьи — при экспорте запись будет удалена с сервера.</p>
</div></details>
...
<div class="footer"><strong>Boostore.pro</strong> — <span data-i18n="footer_text">Управление статьями блога</span> &nbsp;|&nbsp; <a href="https://boostore.pro/ru/docs/api-integration/#hotengine-CommerceAPI" target="_blank" data-i18n="footer_docs">Документация API</a> &nbsp;|&nbsp; <a href="index.php" style="color:#00d4ff;">← На главную</a></div>
</div>
<script>
// ===== i18n Translations =====
var i18n = {
